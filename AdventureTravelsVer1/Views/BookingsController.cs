...
namespace AdventureTravelsVer1.Views
{
    public class BookingsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BookingId,UserId,FlightId,NumberOfAdults,NumberOfKids,BookingAmount")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BookingId,UserId,FlightId,NumberOfAdults,NumberOfKids,BookingAmount")] Booking booking)
        {
            if (ModelState.IsValid)
            {
